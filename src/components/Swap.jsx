...
const Swap = () => {
  ...
  const [ethAmount, setEthAmount] = useState(""); // State to store ETH amount
  const [solAmount, setSolAmount] = useState(""); // State to store SOL amount
  const [isOneToOne, setIsOneToOne] = useState(true); // State to manage 1:1 toggle
